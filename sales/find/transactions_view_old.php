...
<table border="0" align="center" width="100%">
  ...
  <tr>
      ...
      <td width="50" colspan="4"><?php  print $salesman; ?></td>
	   ...
	   <tr>
      <td width="20"></td>
      <td width="135"><font color="<?php print $colour1?>">Δελτίο Αγοράς :</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="50"><?php  print $dotcode."-".$docnumber;?></td>
      <td width="135"><font color="<?php print $colour1?>">Ημερομηνια αγοράς :</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
...
else if ($kind == "Επανεκχώρηση")
{
$query="SELECT username FROM rma.user where userid='$userid'";
$result=mysql_query($query);
...
<table border="0" align="center" width="100%">
  ...
  <tr>
      <td width="20"></td>
      <td width="135"><font color="<?php print $colour1?>">Αποθηκάριος</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="50" colspan="4"><?php  print $username; ?></td>
      </tr>
  ...
  <tr>
      <td width="20"></td>
      <td width="135" valign="top"><font color="<?php print $colour1?>">Λόγος</font></td>
      <td width="10" valign="top"><font color="<?php print $colour1?>">:</font></td>
      <td valign="top" colspan="4" rowspan="5" width="105"><?php  print $details; ?></td>
    </tr>
      <tr>
