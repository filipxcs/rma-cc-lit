...
<input name="id" type="hidden" value="<?print $id?>">
  ...
  <tbody>
    <tr>
      <td width="192"></td>	
      <td width="180"><font color="<?print $colour1?>">Πελάτης</font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><?print $pelaths;?></td>
    </tr>
    <tr>
      <td width="192"></td>
      <td width="180"><font color="<?print $colour1?>">Είδος</font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><?print $kodikos_eidous;?></td>
    </tr>
    <tr>
      <td width="192"></td>
      <td width="180"><font color="<?print $colour1?>">Ημερομηνια </font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><? print $rma_date;?></td>
    </tr>
<tr>
      <td><br> </td>
      <td> </td>
...
<tr>
      <td width="192"></td>
      <td width="180"><font color="<?print $colour1?>">Τιμολόγιο Αγοράς </font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><? print $timologio_agoras; ?></td>
    </tr>
    <tr>
      <td width="192"></td>
      <td width="180"><font color="<?print $colour1?>">Ημερομηνία Αγοράς </font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><? print $dc; ?></td>
    </tr>
    <tr>
      <td width="192"></td>
      <td width="180"><font color="<?print $colour1?>">Ποσότητα</font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><? print $posotita; ?></td>
    </tr>
<tr>
      <td width="192"></td>
      <td width="180"><font color="<?print $colour1?>">Αξία πώλησης</font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><? print $aksia_polisis; ?></td>
    </tr>

<tr>
      <td width="192"></td>
      <td width="180"><font color="<?print $colour1?>">Καθαρή αξία πίστωσης </font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><?print $kathari_aksia_pistosis?></td>
    </tr>
    <tr>
      <td width="192"></td>
      <td width="180" valign="top"><font color="<?print $colour1?>">Λόγος Επιστροφης </font></td>
      <td width="10" valign="top"><font color="<?print $colour1?>">:</font></td>
      <td width="370"><? print $logos_epistrofis ?></td>
    </tr>
<tr>
      <td width="192"><br></td>
    </tr>
<tr>
      <td width="192"></td>
      <td width="190"><font color="<?print $colour1?>">Δελτίο Παραλαβής</font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><?print $deltio_paralavis;?></td>
    </tr>
<tr>
      <td width="192"></td>
      <td width="190"><font color="<?print $colour1?>">Ημερομηνία Παραλαβής</font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><?print $date_paralavis;?></td>
    </tr>
<tr>
      <td width="192"></td>
      <td width="190"><font color="<?print $colour1?>">Κατάσταση Προϊόντος</font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><?print $katastasi_proiontos1;?></td>
    </tr>
<tr>
      <td width="192"></td>
      <td width="190"></td>
      <td width="10"></td>
      <td width="*"><?print $katastasi_proiontos_logos;?></td>
    </tr>
<tr>
      <td width="192"></td>
      <td width="190"><font color="<?print $colour1?>">Κατάσταση Προϊόντος</font></td>
      <td width="10"><font color="<?print $colour1?>">:</font></td>
      <td width="*"><?print $katastasi_siskeuasias1;?></td>
    </tr>
<tr>
      <td width="192"></td>
      <td width="190"></td>
      <td width="10"></td>
      <td width="*"><?print $katastasi_siskeuasias_logos;?></td>
    </tr>
<tr>
      <td width="192"><br></td>
    </tr>
