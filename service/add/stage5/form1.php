...
$query="select id,leename,codcode,itmname,user,serial,problem,pepserial,guar1,guar2,date_format(date,'%d-%c-%Y')AS 'date' from rma.rma_onlinerma where online='$_POST[rma]'and status=0";
...
$ret .="<input type=hidden name=numrows value=$num><input type=hidden name=cmp value=$cmp><input type=hidden name=online_id value=$_POST[rma]><input type=hidden name=id$i value=$id>";
...
$ret .="</tr><tr>";
$ret .="<td width=60><font color=$colour1>Εταιρεία</font></td>";
$ret .="<td width=10><font color=$colour1>:</font></td>";
...
$ret .="<option value='Το προϊόν δεν αγοράστηκε από την εταιρία μας.'>Εκτός Διανομής</option>";
$ret .="<option value='Μη αποδεκτή περιγραφή βλάβης'>Βλάβη</option>";
$ret .="<option value='Λάθος Serial Number'>Λάθος Serial Number.</option>";
...
$ret .="<option value='Για την προ-αντικατάσταση του υλικού σας παρακαλούμε μεταφέρετε με e-banking το ποσό της χρέωσης σε έναν απο τους παρακάτω λογαριασμούς με την ένδειξη RMA.

<table>
<tr><td>Τράπεζα</td> 	   <td>Λογαριασμός</td> 	         <td>IBAN</td></tr>

<tr><td>Eurobank</td> 	<td>00260257260201204188</td> 	<td>GR0802602570000260201204188</td></tr>
<tr><td>Alpha</td> 	   <td>477002002004907</td> 	      <td>GR7701404770477002002004907</td></tr>
<tr><td>Εθνική</td> 	   <td>21847044365</td> 	         <td>GR6101102180000021847044365</td></tr>
<tr><td>Πειραιώς</td> 	<td>5226055573146</td> 	      <td>GR2701722260005226055573146</td></tr>

</table>


Μόλις έχετε κάνει την κατάθεση αποδεχθείτε την προ-αντικατάσταση του υλικού.'>Προαντικατάσταση</option>";
...
$ret .="<option value='Το προϊόν δεν αγοράστηκε από την εταιρία μας. Η χρέωση για την διαχείριση της εγγύησής του είναι 3,5 ευρώ.  Επίσης για την αντικατάστασή του, θα χρεωθείτε την αξία του δίσκου που θα επιλέξετε μειωμένη κατά ΧΧ ευρώ.'>Εκτός Διανομής</option>";
...
$ret .="<option value='To barebone σύστημα πρέπει να παραδοθεί στο τεχνικό μας τμήμα χωρίς CPU, μνήμη και τα λοιπά περιφερειακά. Σε αντίθετη περίπτωση, θεωρείται ότι αποδέχεστε χρέωση τεχνικού ελέγχου συστήματος εκτός εγγύησης.'>Barebone</option>";
...
$ret .="<td width=200><textarea name=\"comments$i\" cols=\"80\" rows=\"7\"></textarea></td>";
$ret .="</tr>";
$ret .="<tr><td><br></td></tr>";
