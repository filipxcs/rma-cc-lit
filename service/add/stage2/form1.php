...
$query="SELECT rmaid,tracode,leename,codcode,itmname,sn,doa,inwar,bumerang,malfunction,date_format(purchdate,'%d-%c-%Y')AS 'purchdate',purchdoc,transport,transportcomments,contactname FROM rmaservice where  codcode='$codcode' and tracode='$traid' AND stageid='1'";
