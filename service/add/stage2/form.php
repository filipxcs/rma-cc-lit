...
$query="SELECT rmaid,tracode,leename,codcode,itmname,sn,online,doa,inwar,bumerang,malfunction,date_format(purchdate,'%d-%c-%Y')AS 'purchdate',purchdoc,transport,transportcomments,contactname FROM rmaservice where rmaid='$_POST[rmaid]' AND stageid='1'";
...
$query="SELECT rmaid from rmaservice where sn='$serial_number' and rmaid!='$_POST[rmaid]%' order by rmaid desc";
$result=mysql_query($query);
$num=mysql_numrows($result);
...
for ($i = 0; $i < $num; $i++ )
    ...
    $return_rmaid=mysql_result($result,$i,"rmaid");
	}
//print $num;	
//print "<br>".$bumerang;
if ($bumerang=="1" && $num=="0")
{$return_comment="Δεν βρεθηκε ο σειριακός αριθμός στην βάση.";}
else if ($bumerang=="2" && $num=="0")
{}
else if ($bumerang=="1" && $num!="0")
{}
else if ($bumerang=="2" && $num!="0")
{$return_comment="Εχει ξανάρθει με RMA :".$return_rmaid;}

//print "<br>".$return_comment;
...
?>
  ...
  <tr>
      <td width="20"></td>
      <td width="135"><font color="<?php print $colour1?>">Online RMA (Εταιρεία)</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="220"><?php  print $online." - (".$cmp.")"; ?><input name="kodikos_pelath" type="hidden" value="<?php  print $online; ?>"><input name="company" type="hidden" value="<?php  print $company; ?>"></td>
...
<tr>
    ...
    <tr>
      ...
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="220"><select name="package" >
     ...
     <td width="20"></td>
      ...
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="220" rowspan="2"><textarea name="package_details" cols="30" rows="2"></textarea> </td>
    </tr>
    <tr>
    <td>&nbsp;</td>
    </tr>    
    ...
    <tr>
      <td width="20"></td>
      <td width="135" valign="top"><font color="<?php print $colour1?>">Παρατηρήσεις Παραλαβής</font></td>
      <td width="10" valign="top"><font color="<?php print $colour1?>">:</font></td>
      <td colspan="7" width="125"><textarea name="parathrhseis_paralavis" cols="50" rows="3"><?php  print $return_comment; ?></textarea> </td>
    </tr>
    <tr>
