...
{
$query="SELECT * FROM sales_stage1 where  id = '$_POST[item]' AND part='1' AND egrisi='1' order by id";
...
{
$query="SELECT * FROM sales_stage1 where  pelaths  like  '$_POST[item]%' AND part='1' AND egrisi='1' order by id";
$result=mysql_query($query);
$num=mysql_numrows($result);
mysql_close();
for ($i = 0; $i < $num; $i++ )
...
{
$query="SELECT * FROM sales_stage1 where  kodikos_eidous  like  '%$_POST[item]%' AND part='1' AND egrisi='1' order by id";
$result=mysql_query($query);
$num=mysql_numrows($result);
mysql_close();
for ($i = 0; $i < $num; $i++ )
...
{
$query="SELECT * FROM sales_stage1 where  part='1' AND egrisi='1' order by id";
$result=mysql_query($query);
$num=mysql_numrows($result);
mysql_close();
for ($i = 0; $i < $num; $i++ )
