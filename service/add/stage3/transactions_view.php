...
<?php 
$query="SELECT rmaid,stageid,tracode,leename,codcode,itmname,sn,doa,inwar,bumerang,noreason,userblame,malfunction,peppercode,date_format(purchdate,'%d-%c-%Y')AS 'purchdate',purchdoc,transport,transportcomments,contactname,company FROM rmaservice where rmaid='$rmaid'";
...
<table border="0" align="center" width="100%">
  ...
  <tr>
      <td width="20"></td>
      <td width="135"><font color="<?php print $colour1?>">Τεχνικός - Εταιρεία</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="50" colspan="4"><?php  print $username." - ".$cmp; ?></td>
      </tr>      
 <tr>
      <td width="20"></td>
