...
<hr>
  ...
  <tbody>
   <tr>
      <td width="20"></td>
      <td width="160"><font color="<?php print $colour1?>">Αριθμός RMA :</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="70"><?php print $rmaid;?></td>
      <td width="150"><font color="<?php print $colour1?>">Ημερομηνια :</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
  ...
  <tr>
      <td width="20"></td>
      <td width="160"><font color="<?php print $colour1?>">Τεχνικός</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="70" colspan="4"><?php print $username; ?></td>
      </tr>      
     <tr>
      <td width="20"></td>
      <td width="160"><font color="<?php print $colour1?>">Χρέωση</font></td>
      <td width="10"><font color="<?php print $colour1?>">:</font></td>
      <td width="70" colspan="4"><?php print $value; ?></td>
</tr>
 <tr>
      <td width="20"></td>
      <td width="160" valign="top"><font color="<?php print $colour1?>">Παρατηρήσεις</font></td>
      <td width="10" valign="top"><font color="<?php print $colour1?>">:</font></td>
      <td valign="top" colspan="4" rowspan="2" width="205"><?php print $comment; ?></td>
    </tr>
