...
<body bgcolor="#333333">
<FORM action="addb.php"  target="mainFrame" method=post>
<?
...
{
$query="SELECT * FROM adda where  id = '$_POST[item]' AND part='1' order by id";
...
{
$query="SELECT * FROM adda where  eppl  like  '$_POST[item]%' AND part='1' order by id";
$result=mysql_query($query);
$num=mysql_numrows($result);
mysql_close();
for ($i = 0; $i < $num; $i++ )
...
{
$query="SELECT * FROM adda where  codeeid  like  '%$_POST[item]%' AND part='1' order by id";
$result=mysql_query($query);
$num=mysql_numrows($result);
mysql_close();
for ($i = 0; $i < $num; $i++ )
...
{
$query="SELECT * FROM adda where  part='1' order by id";
$result=mysql_query($query);
$num=mysql_numrows($result);
mysql_close();
for ($i = 0; $i < $num; $i++ )
